...
{
    public class TransmogrificationMadeHandlerAsync(
        IAmARelationalDbConnectionProvider relationalDbConnectionProvider,
        IAmACommandProcessor commandProcessor,
        ILogger<TransmogrificationMadeHandlerAsync> logger)
        : RequestHandlerAsync<TransmogrificationMade>
    {
        [UseInboxAsync(step:0, contextKey: typeof(TransmogrificationMadeHandlerAsync), onceOnly: true, onceOnlyAction: OnceOnlyAction.Warn )] 
